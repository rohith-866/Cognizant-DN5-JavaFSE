 ...
 *
 * Tests and compares Linear Search vs Binary Search
 * on a product catalog.
 *
 * ─────────────────────────────────────────────────
 * BIG O NOTATION EXPLAINED (for reference):
 *
 * Big O notation describes how an algorithm's speed
 * grows as the input size (n) increases.
 *
 *   O(1)      → Constant   : Always same speed, regardless of n
 *   O(log n)  → Logarithmic: Very fast, halves the problem each step
 *   O(n)      → Linear     : Speed grows directly with n
 *   O(n²)     → Quadratic  : Speed grows very fast (nested loops)
 *
 * For search:
 *   Linear Search  → O(n)      unsorted array, checks one by one
 *   Binary Search  → O(log n)  sorted array, halves the search space
 * ─────────────────────────────────────────────────
 */
public class EcommerceSearchTest {
    ...
    public static void main(String[] args) {
        ...
        // (Same products, sorted by productId in ascending order)
        ...
        // ════════════════════════════════════════════
        //  TEST 1: LINEAR SEARCH — Best Case O(1)
        //  Searching for product at the START of array
        // ════════════════════════════════════════════
        ...
        // ════════════════════════════════════════════
        //  TEST 2: LINEAR SEARCH — Worst Case O(n)
        //  Searching for product at the END of array
        // ════════════════════════════════════════════
        ...
        // ════════════════════════════════════════════
        //  TEST 4: BINARY SEARCH — Best Case O(1)
        ...
        // ════════════════════════════════════════════
        //  TEST 5: BINARY SEARCH — Worst Case O(log n)
        //  Searching for element at the far end
        // ════════════════════════════════════════════
